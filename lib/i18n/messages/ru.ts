...
export const ruMessages: Messages = {
  ...
  "forgot.subtitle":
    "Введите email, и после включения функции мы отправим инструкции по сбросу.",
  "forgot.sendResetLink": "Отправить ссылку",
  "forgot.backToSignIn": "Назад ко входу",
  "forgot.notWired":
    "Сброс пароля по email пока не подключен. Когда функция появится, вы получите инструкции на указанный адрес.",
